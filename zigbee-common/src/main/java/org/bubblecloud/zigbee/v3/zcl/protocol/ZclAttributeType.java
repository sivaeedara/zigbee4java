...
public enum ZclAttributeType {
    ...
    THERMOSTAT_CURRENT_OPERATING_MODE(ZclClusterType.THERMOSTAT, 41, "CurrentOperatingMode", true, true, ZigBeeType.SignedInteger16bit, java.lang.Integer.class),
    THERMOSTAT_RUNNING_MODE(ZclClusterType.THERMOSTAT, 30, "RunningMode", true, true, ZigBeeType.SignedInteger16bit, java.lang.Integer.class),
    THERMOSTAT_SETPOINT_DEAD_BAND(ZclClusterType.THERMOSTAT, 25, "SetpointDeadBand", true, true, ZigBeeType.SignedInteger8bit, java.lang.Integer.class),
